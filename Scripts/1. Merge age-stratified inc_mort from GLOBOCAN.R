# =====================================
# Script: Flexible GLOBOCAN Data Processor
# Author: Ke Pang (Enhanced by Claude)
# Date: 2025-08-12
# Purpose: Flexible script to process GLOBOCAN age-stratified data for different cancers and data types
# Data: Handles colorectum/rectum and incidence/mortality combinations
# =====================================

library(dplyr)

#1. Configuration - Change these parameters ----
CANCER_TYPE <- "lip-oral-cavity"  # Options: "colorectum" or "rectum"
DATA_TYPE <- "inc"           # Options: "inc" (incidence) or "mort" (mortality)
YEAR <- "2022"               # Data year

#2. Automatic setup - No need to modify ----

# Set up paths and filenames based on parameters
data_dir <- file.path("Data", CANCER_TYPE)
